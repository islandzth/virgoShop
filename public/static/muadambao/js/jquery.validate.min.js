...
jQuery.extend(jQuery.validator.messages, {
    ...
    url: "Địa chỉ URL không hợp lệ. Nhập theo định dạng: http://website.com",
    date: "Ngày tháng không hợp lệ",
    dateISO: "Ngày tháng không hợp lệ",
    ...
    min: jQuery.validator.format("Vui lòng nhập thấp nhất là {0}"),
});