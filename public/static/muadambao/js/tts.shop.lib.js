var TTS = {};
var matchUser = [],
    fbGraphUrl, fbFriendCache;
var isLoadFriendList = false;
...
TTS.Framework = {};
TTS.Framework.District = {};
TTS.Framework.Product = {};

TTS.Framework.Message = {};
TTS.Framework.Cart = {};
TTS.Framework.GrabImage = {};
TTS.Facebook = {};
TTS.Framework.Retailer = {};
...
function showAlert(message, type, timeout) {
    ...
    $("#alertModalInner").html('<div class="alert ' + styleClass + ' alert-dismissable btn-radius"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>' + message + '</div>');
...
// Login facebook with popup inspired by DISQUS
(function($) {
    ...
    $.oauthpopup = function(options) {
        ...
        options = $.extend({
            windowName: 'Đăng-nhập-bằng-Facebook' // should not include space for IE
            ,
            windowOptions: 'location=0,status=0,width=500,height=300',
            callback: function() {
...
(function(k) {
    ...
    k._formatNumber = function(m, q, n, G, s) {
        var q = k.extend({}, k.fn.formatNumber.defaults, q);
        var E = e(q.locale.toLowerCase());
        var D = E.dec;
        var v = E.group;
        var l = E.neg;
        var x = false;
    ...
    k.parseNumber = function(r, v) {
        var v = k.extend({}, k.fn.parseNumber.defaults, v);
        var m = e(v.locale.toLowerCase());
        var o = m.dec;
        var t = m.group;
        var p = m.neg;
        var l = "1234567890.-";
