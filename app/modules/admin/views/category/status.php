                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i>Thêm danh mục
                            </h4>
...
<script
    src="<?= ADMIN_STATIC_URL ?>assets/bootstrap/js/bootstrap.min.js"></script>
...
<script type="text/javascript"
        src="<?= ADMIN_STATIC_URL ?>assets/data-tables/jquery.dataTables.js"></script>
<script type="text/javascript"
        src="<?= ADMIN_STATIC_URL ?>assets/data-tables/DT_bootstrap.js"></script>
<script type="text/javascript"
        src="<?= ADMIN_STATIC_URL ?>assets/uniform/jquery.uniform.min.js"></script>
